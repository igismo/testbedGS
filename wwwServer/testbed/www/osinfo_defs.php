...
class OSinfo
{
	...
	$retval = SUEXEC("www", "www", "webnewosid $xmlname",
	...
	echo "<tr>
                <td>Project: </td>
                <td class=\"left\">
                  <a href='showproject.php?pid=$os_pid'>$os_pid</a></td>
              </tr>\n";
	...
	if ($nextosid) {
		...
		echo "<tr>
                        <td>Next Osid: </td>
                        <td class=left>
                            <a href='showosinfo.php?osid=$nextosid'>
                                            $nextosid</a></td>
                      </tr>\n";
	}
	if ($ezid) {
		echo "<tr>
                        <td>Image Link: </td>
                        <td class=left>
                            <a href='showimageid.php?imageid=$osid'>
                                            $os_osname</a></td>
                      </tr>\n";
	}
