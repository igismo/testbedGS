...
function SPITFORM($formfields, $errors)
{
    ...
    echo "(<a href=kb-search.php>Search For Entries</a>)</center>\n";
    ...
    echo "<br>
          ...
          <form action='kb-manage.php' method=post>\n";
...
if (isset($idx) && (!isset($action) || $action != "delete")) {
	...
	header("Location: kb-show.php?xref_tag=".
	       str_replace("'", "", $xref_tag));
    }
    else {
	header("Location: kb-show.php?idx=$idx");
    }
}
else {
    # Redirect to the search page.
    header("Location: kb-search.php");
}
?>
