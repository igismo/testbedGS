...
#
# This page is a generic toggle page, like adminmode.php, but more
...
$toggles = array("adminon", "webfreeze", "lockdown", "stud",
		         "workbench", "hiderun", "widearearoot");
...
elseif ($zapurl) {
    ...
    header("Location: $TBBASE/showuser.php");
}
