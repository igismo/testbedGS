...
WRITESUBMENUBUTTON("Create a Mailman List", "newmmlist.php");

if ($isadmin) {
    WRITESUBMENUBUTTON("Show User Lists", "showmmlists.php?showallmm=1");
}
SUBMENUEND();
...
#
SUEXEC($uid, "www", "webmmlistmembership $target_uid", SUEXEC_ACTION_DIE);
...
if (count($suexec_output_array)) {
	...
	echo "<tr>
                  ...
                  <td align=center>
                       <a href='gotommlist.php?listname=$listname'>
                         <img src=\"arrow4.ico\"
...
if (mysql_num_rows($query_result)) {
	...
	echo "<tr>
                  ...
                  <td align=center>
                       <A href='delmmlist.php?listname=$listname'>
