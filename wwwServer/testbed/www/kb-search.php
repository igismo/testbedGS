...
if (!isset($embedded)) {
    ...
    #
    # Sheesh. This file is included from search.php, hence the sillyness.
    #
    $embedded = 1;
    $admin_access = 0;
}
...
function SPITFORM($query, $query_type, $query_which, $error)
{
    ...
    echo "<table align=center border=1>
          <form action=kb-search.php method=get>\n";
    ...
    echo "<center>".
	 "You may also <a href=$TBBASE/kb-browse.php>
...
while ($row = mysql_fetch_array($search_result)) {
	...
	echo "<a href=kb-show.php?xref_tag=$xref_tag>$title</a>\n";
    }
    else {
	echo "<a href=kb-show.php?idx=$idx>$title</a>\n";
    }
}
