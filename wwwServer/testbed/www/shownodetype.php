...
# physical node is free, see note in nodecontrol_list.php for why.
#
$query_result =
...
if (mysql_num_rows($query_result)) {
    echo "<br>
          <center>
	  Nodes (<a href=nodecontrol_list.php?showtype=$node_type>Show details</a>)
	  <br>
	...
	echo "&nbsp;";
#	echo "<a href=shownode.php?node_id=$node_id>";
	echo "$node_id";
#	echo "</a>";
	echo "</nobr>
              </td>\n";
