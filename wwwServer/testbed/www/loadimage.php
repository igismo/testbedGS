...
# This isn't quite right on DETER.  It looks for a state change in the 
# underlying experiment and produces confusing  error messages.  
# The experiment is already in the state it is looking for and this returns 
# immediately with a done message, which makes a user think a snapshot is done 
