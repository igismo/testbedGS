...
# All rights reserved.
#
## GORAN include("defs.php");
include "gorantest.php";
...
elseif (isset($formfields["exp_localnsfile"]) &&
	...
	$errors["Server NS File"] = "Pathname includes illegal characters";
			  ...
			  $formfields["exp_localnsfile"])) {
	$errors["Server NS File"] = "Filename has invalid extension: file must be plain text";
...
$retval =0;
##echo "\nGORAN 5";
#createbatchexp($exp_pid,$exp_gid, $exp_id,$linktestarg, $extragroups, $exp_swappable,
