...
{
    global $TBDB_UIDLEN, $TBDB_PIDLEN, $TBDB_GIDLEN, $isadmin, $this_user;
    global $target_user;
	...
	echo "<tr></tr>\n";
	echo "<tr>
                  <td colspan=2>DETER Password[<b>1</b>]:</td>
                  <td class=left>
                      <input type=password
        ...
        echo "<tr>
                  <td colspan=2>Retype DETER Password:</td>
                  <td class=left>
                      <input type=password
        ...
        echo "<tr>
                  ...
                  <td class=left>
                      <input type=text
                             ...
                             size=8>Do <b>not</b> use your DETER password.</td>
              </tr>\n";
