    ...
    $output = "<table valign=top align=center width=100% height=100%
                ...
                <tr><td class=menuoptusage align=right>$active_expts</td>
                    <td align=left class=menuoptusage>
                        <a target=_parent href=explist.php#active>Active</a>
                    </td></tr>
                ...
                <tr><td align=right class=menuoptusage>$swapped_expts</td>
                    <td align=left  class=menuoptusage>
                        <a target=_parent href=explist.php#swapped>Swapped</a>
                    </td></tr>";
    if (!$mini) {
	$output .= "<tr><td align=right class=menuoptusage>
                        <font size=+1>$freepcs / $totalpcs</font></td>
                    <td align=left  class=menuoptusage>
                        <font size=+1>PCs Free</font></td>
                </tr>";
    }
    $output .= "</table>\n";
    return $output;
...
function ShowStatus()
{
    ...
    $output .= "<tr><td nowrap class=usagefreenodes>$freepcs / $totalpcs PCs Free</td>".
	"</tr>\n";
    $output .= "<tr><td nowrap class=usagefreenodes>$reservedpcs PCs reserved</td>".
	"</tr>\n";
