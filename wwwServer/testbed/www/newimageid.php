    ...
    echo "<h4><blockquote><blockquote><blockquote>
          <ol type=1 start=1>
             ...
             <li>If you are using a custom OS, you must
                  <a href='newosid.php'>create the OS Descriptor
                  first!</a>
...
if (isset($formfields["part1_osid"]) && $formfields["part1_osid"] != "") {
    $args["part1_osid"] = $formfields["part1_osid"];
}

if (isset($formfields["part2_osid"]) && $formfields["part2_osid"] != "") {
    $args["part2_osid"] = $formfields["part2_osid"];
}

if (isset($formfields["part3_osid"]) && $formfields["part3_osid"] != "") {
    $args["part3_osid"] = $formfields["part3_osid"];
}

if (isset($formfields["part4_osid"]) && $formfields["part4_osid"] != "") {
