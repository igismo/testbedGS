...
if (!isset($splitview) || !$isadmin)
    ...
    if ($isadmin) {
    if (! $splitview) {
	echo "<b><a href='showproject_list.php?splitview=1'>Split View</a>
              </b><br>\n";
    }
    else {
	echo "<b><a href='showproject_list.php'>Normal View</a>
              </b><br>\n";
    }
}
...
function GENPLIST ($query_result)
{
    ...
    echo "<table width='100%' border=2 id='$tablename' class='sortable'
	...
	if ($status=="approved") {
	    ...
	    #
	    # include a link to the approval page if we're admin
	    if ($isadmin)
		echo "<a href=\"approveproject_form.php?pid=$pid\">";
	    echo "<img alt='N' src='redball.gif' border=\"0\">\n";
	    if ($isadmin)
		echo "</a>";
