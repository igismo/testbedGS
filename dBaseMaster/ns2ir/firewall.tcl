...
Firewall instproc init {s} {
    ...
    var_import ::GLOBALS::firewall_override
    ...
    # Disable firewalls unless override is specified
    if { $firewall_override != "Firewalls do not work" } {
        perror "DETER does not support firewalled experiments:\n\tThe testbed is already firewalled from the internet."
    }
